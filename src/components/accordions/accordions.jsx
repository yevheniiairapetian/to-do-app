    ...
    return (
        ...
        <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                    To change the username after initial set up, click on the username in the top right of the navigation, enter a new username, then click anywhere in the app. Click on the <strong>"Add a New List"</strong> button to create a clean list of To-dos. Type in the To-do and click on the "Add a to-do" button or press on "Enter" key.
            ...
            <Accordion.Item eventKey="1">
                <Accordion.Header>Touch screen
                    devices:</Accordion.Header>
                <Accordion.Body>
                o change the username after initial set up, tap on the username in the top right of the navigation, enter a new username, then tap anywhere in the app. Tap on the <strong>"Add a New List"</strong> button to create a clean list of
