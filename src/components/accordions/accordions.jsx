...
export const Accordions = () => {
    return (
        ...
        // 				data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Desktop or
        // 				laptop
        // 				devices:</button>
        // 		</h2>
        ...
        // 				Click on <strong>"Add New List"</strong> to create a topic-related list of To-dos. Type in the To-do and click on "Add to-do" button or press on "Enter" key.
        // 				<strong>Double-click</strong> to mark an item off, click on <strong>"X"</strong> to delete an
        // 				item, and
        // 				drag items to reorder. If you want to delete all
        // 				to-dos at once, press <strong><code>CTRL + Left Mouse Click</code></strong> on any to-do or
        // 				click the <strong> trash button</strong>. Click the
        // 				<strong>broom</strong> button to clean up the input field. Click on the List Title to edit it.
        // 				Click on <code>Save My Edits Button</code> to save your edits. And click on <strong>"X"</strong>
        ...
        // 			<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
        // 				data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Touch screen
        // 				devices:
        // 			</button>
        // 		</h2>
        // 		<div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo"
        // 			data-bs-parent="#accordionExample">
        // 			<div className="accordion-body">Tap on <strong>"Add New List"</strong> to create a topic-related list of
        // 				To-dos. Type in the To-do and tap on "Add to-do" button or tap on "Enter".
        // 				One tap to mark an item off, click on <strong>"X"</strong> to delete an item, tap and drag items
        // 				to reorder. Tap on the List Title to edit it. Click the
        // 				<strong>broom</strong> button to clean up the input field. If you want to delete all
        // 				to-dos at once, tap on <strong>the trash button</strong>. Tap on
        // 				<code>Save My Edits Button</code> to save your edits. And tap on <strong>"X"</strong> to delete
        // 				the whole list.
        // 			</div>
        // 		</div>
        // 	</div>
        ...
        <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                    Click on the <strong>"Add a New List"</strong> button to create a clean list of To-dos. Type in the To-do and click on the "Add a to-do" button or press on "Enter" key.
            ...
            <Accordion.Item eventKey="1">
                <Accordion.Header>Touch screen
                    devices:</Accordion.Header>
                <Accordion.Body>
                    Tap on the <strong>"Add a New List"</strong> button to create a clean list of
                    To-dos. Type in the To-do and tap on the "Add a to-do" button or hit "Enter".
                    Long-tap to mark an item off and click on the <strong>"X"</strong> at the end of each item to delete an item. Tap on the List Title to edit it. Click the
